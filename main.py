...
parser.add_argument('--trainset', type=str,
                    default='/home/aniket/coqa/data/coqa.train.json', help='training dataset file')
parser.add_argument('--devset', type=str,
                    default='/home/aniket/coqa/data/coqa.dev.json', help='development dataset file')
parser.add_argument('--model_name', type=str, default='BERT',
                    help='[BERT|RoBERTa|DistilBERT|SpanBERT]')
...
parser.add_argument('--num_examples', type=int, default=5000,
                    help='number of examples to be selected for training')
parser.add_argument('--n_history', type=int, default=2,
                    help='number of previous question to use as previous context')
